...
# auth=rtweet_app("AAAAAAAAAAAAAAAAAAAAAD6UjQEAAAAAjSO4XcN8%2FSuPyK59OdQeZ%2FbroOQ%3D5Fq7glOeUdVCJ0ESx97lvYPfHlb6saIVSyD7Hrq2kGg6f07LyS")
...
fa <- search_tweets("@Frente_amplio", n = 18000, include_rts = TRUE,retryonratelimit=TRUE)
...
serie_lp$screen_name="LuisLacallePou"
